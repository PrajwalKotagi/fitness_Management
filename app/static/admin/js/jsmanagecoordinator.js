...
$(document).on("click", "#btn_update", function () {
    ...
    if ($("#txtCreatId1").val().trim().length < 1) {
    ...
    formData.append("txtCreatId1", $("#txtCreatId1").val());
